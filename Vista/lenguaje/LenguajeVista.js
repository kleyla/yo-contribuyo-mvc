...
var tableLenguajes;
var lenguajeVista = new LenguajeVista();

document.addEventListener("DOMContentLoaded", function () {
  // NUEVO LENGUAJE
  lenguajeVista.initTable();
  lenguajeVista.setLenguaje();
});

function editLenguaje(id) {
  lenguajeVista.editLenguaje(id);
}
function deleteLenguaje(id) {
  lenguajeVista.deleteLenguaje(id);
}
function enableLenguaje(id) {
  lenguajeVista.enableLenguaje(id);
}
