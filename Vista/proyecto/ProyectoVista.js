...
var tableProyectos;
var proyectoVista = new ProyectoVista();

document.addEventListener("DOMContentLoaded", function () {
  proyectoVista.initTable();
  proyectoVista.setProyecto();
  proyectoVista.editProyecto();
});

function deleteProyecto(id) {
  proyectoVista.deleteProyecto(id);
}
function enableProyecto(id) {
  proyectoVista.enableProyecto(id);
}
