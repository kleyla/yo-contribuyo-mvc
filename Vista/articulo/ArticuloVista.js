...
var tableArticulos;
var articuloVista = new ArticuloVista();

document.addEventListener("DOMContentLoaded", function () {
  articuloVista.initTable();
  articuloVista.setArticulo();
  articuloVista.editArticulo();
});

function deleteArticulo(id) {
  articuloVista.deleteArticulo(id);
}
function enableArticulo(id) {
  console.log("Enable");
  articuloVista.enableArticulo(id);
}
